...
int main()
{
  ...
  double dist=0,angle=0,speed=0.4,acceleration=0.5,angular_acceleration=1;
...
/*  end of mission  */
  ...
  double d = mot.dist - (odo.right_pos_dec+odo.left_pos_dec)/2;
  double vmax = sqrt(2*acceleration*d);
  double angle_left = mot.angle - odo.angle_pos_mission;
